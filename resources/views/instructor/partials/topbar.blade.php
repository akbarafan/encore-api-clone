<div class="topbar d-flex justify-content-between align-items-center flex-wrap">
    <div class="mb-2 mb-md-0">
        ...
        <small class="text-muted">@yield('page-subtitle', 'Welcome to your instructor panel')</small>
    </div>
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <div class="dropdown">
            <button class="btn btn-outline-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-sm-inline">{{ $instructor->name ?? 'Instructor' }}</span>
            </button>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><h6 class="dropdown-header">{{ $instructor->name ?? 'Instructor' }}</h6></li>
                <li><hr class="dropdown-divider"></li>
                <li>
